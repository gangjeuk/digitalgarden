...
## 메모리(RAM)을 관리하는 법
### 메모리 관리의 역사와 CPU의 발전
1. [[kr/운영체제/운영체제 메모리(1) - 페이징, 세그멘테이션 뭐가 다르고 왜 나온겨여\|운영체제 메모리(1) - 페이징, 세그멘테이션 뭐가 다르고 왜 나온겨여]]
### 세그멘테이션
### 페이징
...
### DMA
1. [[kr/운영체제/Minix와 Intel 8086으로 알아보는 DMA 원리(1)\|Minix와 Intel 8086으로 알아보는 DMA 원리(1)]]